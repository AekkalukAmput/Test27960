...
class Statebor2 extends React.Component {
  constructor() {
    super();
    this.state = {
      data1: '',
  ...
  componentDidMount () {
    ...
    const url1 = 'http://127.0.0.1/test/database2.php';
...
<div style={styles.apDiv5}>
  ...
  <div style={styles.apDiv8}><p style={styles.font}>บ่อที่:2</p></div>
